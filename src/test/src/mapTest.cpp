...
void mapTest(){
        ...
        ft::pair<int, std::string> p0 = ft::make_pair(0, "Coucou");
        ft::pair<int, std::string> p1 = ft::make_pair(1, "comment");
        ft::pair<int, std::string> p2 = ft::make_pair(2, "ca");
        ft::pair<int, std::string> p3 = ft::make_pair(3, "va");
        test2.insert(p0);
        test2.insert(p1);
        test2.insert(p2);
        test2.insert(p3);
        ...
        ft::map<int, std::string>::iterator it3 = test2.begin();
        ft::map<int, std::string>::iterator ite3 = test2.end();
        ft::map<int,std::string> test3(it3, ite3);

        print_map(test3);

        std::cout << "Contructeur par copie: " << std::endl;
        ft::map<int,std::string> test(test3);
        print_map(test);

        std::cout << "Operateur =: " << std::endl;
        ft::map<int,std::string> test4;
        test4 = test;
        print_map(test4);
        ...
        ft::map<int, std::string>::iterator it = test4.begin();
        std::cout << "BEGIN: " << std::endl << "Key: " << it->first << " : " << it->second << std::endl << std::endl; 
        ft::map<int, std::string>::iterator ite = test4.end();
        std::cout << "END: " << std::endl; 
        std::cout << "-- sur end: " << std::endl;
        --ite;
        std::cout << "Key: " << ite->first << " : " << ite->second << std::endl << std::endl; 

        ft::map<int, std::string>::reverse_iterator rit = test4.rbegin();
        ft::map<int, std::string>::reverse_iterator rite = test4.rend();
...
// test sur const it ?
        ...
        ft::pair<int, std::string> p4 = ft::make_pair(4, "bien");
        ft::pair<ft::map<int, std::string>::iterator, bool> ret = test2.insert(p4);
        print_map(test2);
        std::cout << std::endl;
        std::cout << "Was the pair unique and inserted ? " << ret.second << std::endl;
        std::cout << "inserting pair(2, \"HELLO\")" << std::endl;
        ft::pair<int, std::string> p5 = ft::make_pair(2, "HELLO");
        ret = test2.insert(p5);
        print_map(test2);
        std::cout << std::endl;
        std::cout << "Was the pair unique and inserted ? " << ret.second << std::endl;
        ...
        ft::map<int, std::string>::iterator it4 = (test2.begin())++;
        ft::map<int, std::string>::iterator ite4 = test2.end();
        ite4--;
        ...
        ft::pair<ft::map<int,std::string>::iterator, ft::map<int,std::string>::iterator> retEr;
        ...
        ft::map<int, int>	test6;
        ft::map<int, int>	test7;
        ft::map<int, int>	test8;

        for (int i = 0; i < 20; i++)
            test6.insert(ft::make_pair(i, i * i));
        for (int i = 0; i < 20; i++)
            test7.insert(ft::make_pair(i, i * i));
        for (int i = 0; i < 100; i++)
            test8.insert(ft::make_pair(i, i * i));
